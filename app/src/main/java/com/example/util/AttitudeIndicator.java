...
public class AttitudeIndicator extends View {
  ...
  private static final int SKY_COLOR = Color.parseColor("#21F3ED");
  private static final int EARTH_COLOR = Color.parseColor("#ffffff");
  private static final int MIN_PLANE_COLOR = Color.parseColor("#FF0000");
...
Context context;
  ...
  private Bitmap getSrc() {
    ...
    float minPlaneCircleRadiusX = mWidth / 36;
    float minPlaneCircleRadiusY = mHeight / 36;
    ...
    canvas.drawLine(centerX, centerY + minPlaneCircleRadiusY, centerX, centerY
        + minPlaneCircleRadiusY + mHeight / 2, mMinPlanePaint);
